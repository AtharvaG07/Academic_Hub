...
if ($row) {
    ...
    $name = "No data found"; // You can customize this message
    $image = "default_image.jpg"; // Provide a default image or handle accordingly
}

// You can now safely use $name and $image
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <!-- <li><a href="student_leave.php"><i class="fa fa-circle-o disabled"></i> Leave Student</a></li> -->
          </ul>
        </li>
        ...
        <!-- <li>
          <a href="#" class="disabled">
              <i class="fa fa-yen"></i> <span>Petty Cash(Locked)</span>
          </a>
        </li>

        <li>
          <a href="#" class="disabled">
            <i class="fa fa-money"></i> <span>Student Payment(Locked)</span>
          </a>
        </li> -->
