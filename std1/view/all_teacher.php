...
if($cant_remove1 > 0 || $cant_remove2 > 0 || $cant_remove3 > 0 || $cant_remove4 > 0 || $cant_remove5 > 0 || $cant_remove6 > 0 || $cant_remove7 > 0 || $cant_remove8 > 0 || $cant_remove9 > 0 || $cant_remove10 > 0){
	...
	echo ' <a href="#" onClick="addSalary(this)" class="btn btn-success btn-xs disabled"  data-id="'.$index.','.$id.'">Add Salary</a>';
	echo ' <a href="#" onClick="viewPayments(this)" class="btn btn-info btn-xs disabled"  data-id="'.$index.'">View Payments</a>';
