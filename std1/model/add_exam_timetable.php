...
if(isset($_POST["do"])&&($_POST["do"]=="add_exam_timetable")){
    ...
    // Corrected SQL query with quotes around time values and adjusted logic
    $sql1 = "SELECT * FROM exam_timetable 
             WHERE day='$day' 
    ...
    if(mysqli_num_rows($result1) > 0) { // MSK-000143-1 At this time there already have class, in that classroom.
        ...
        if(mysqli_query($conn, $sql)){
            $msg += 2; // MSK-000143-3 The record has been successfully inserted into the database.
        } else {
